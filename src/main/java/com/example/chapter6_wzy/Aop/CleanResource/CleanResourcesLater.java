package com.example.chapter6_wzy.Aop.CleanResource;

import com.example.chapter6_wzy.Annotations.ResourceClean.CleanupResources;
import com.example.chapter6_wzy.Utils.Md5;
...
public class CleanResourcesLater {
    ...
    @Pointcut("@annotation(com.example.chapter6_wzy.Annotations.ResourceClean.CleanupResources))")
